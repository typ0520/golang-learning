...
func main() {
	...
	fmt.Println(hex.EncodeToString([]byte("assasa")))
...
func ExampleNewGCM_encrypt() {
	...
	key, _ := hex.DecodeString("6368616e676520746869732070617373776f726420746f206120736563726574")
	plaintext := []byte("76cd2174597b432b240eef666b52d492d4250e0e069b17e7fb7a324eb5b3467d")
...
func ExampleNewGCM_decrypt() {
	...
	// When decoded the key should be 16 bytes (AES-128) or 32 (AES-256).
	key, _ := hex.DecodeString("6368616e676520746869732070617373776f726420746f206120736563726574")
	ciphertext, _ := hex.DecodeString("88fd761de26d25d49b338ffc1d439457c6cba7a2d1d848cba2875aa4b2f81163")
	nonce, _ := hex.DecodeString("34cc9350b38147e6647e5d00")
